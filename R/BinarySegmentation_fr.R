...
fr_theta_initial_IN_optim <- function(phitilde_N_3, changepoints_1, changepoints_2, changepoints_3) {
  ...
  theta_ini <- c(omegatilde_N_ascend[changepoints_1], alphatilde_N_ascend[changepoints_2], betatilde_N_ascend[changepoints_3])
  return(theta_ini)
}
